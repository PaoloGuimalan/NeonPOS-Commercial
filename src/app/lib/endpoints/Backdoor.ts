const BACKDOOR = {
  ...
  CREATE_PERMISSIONS: '/api/settings/createpermissions',
  DELETE_PERMISSION: (id: string) => `/api/settings/deletepermission/${id}`,
  GET_USER: `/api/auth/getusers/`,
  GET_CURRENT_USER: (id: string) => `/api/auth/getuser/${id}`,
